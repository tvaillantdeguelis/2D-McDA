...
def _global_attributes(request, result, filename):
    ...
    attributes = {
        ...
        "source": (
            f"CALIOP Level 1 {CALIOP_L1_PRODUCT_TYPE} " f"V{request.caliop_version}"
        ),
        "processing_level": "L2",
        "product_version": f"V{request.output_version}",
        "featureType": "trajectoryProfile",
        "date_created": created,
        "history": f"{created}: generated by 2D-McDA V{request.output_version}",
