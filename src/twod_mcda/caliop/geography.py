...
def get_prof_min_max_indexes_from_lon(lon, lon_prof_min, lon_prof_max):
    ...
    """
    lon = _lon_m180_180_to_0_360(lon)
    lon_prof_min = _lon_m180_180_to_0_360(lon_prof_min)
    lon_prof_max = _lon_m180_180_to_0_360(lon_prof_max)

    index_prof_min = int(np.argmin(np.abs(np.asarray(lon) - lon_prof_min)))
    index_prof_max = int(np.argmin(np.abs(np.asarray(lon) - lon_prof_max)))
